...
name: where-we-are
description: v1.4.0 (Local) | Session awareness - what we're doing now. Use when user asks "now", "where are we", "what are we doing", "status". Quick mode for timeline, deep mode for full context.
---
